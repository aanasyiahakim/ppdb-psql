 ...
 */
    ...
    class ref_berkasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Berkas PDB');
            $this->SetMenuLabel('Berkas PDB');
    ...
    try
    {
        $Page = new ref_berkasPage("ref_berkas", "ref.berkas.php", GetCurrentUserPermissionsForPage("ref.berkas"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ref.berkas"));
