 ...
 */
    ...
    class lap_pendaftarPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Progres Pendaftar');
            $this->SetMenuLabel('Progres Pendaftar');
    
            $selectQuery = 'SELECT 
              date_format(p.tanggal_dibuat, "%d-%m-%Y") tanggal, 
              pp.id_kk kk, pp.pilihan pilihan, count(*) banyak 
            FROM `pdb` p 
            INNER JOIN pdb_pilihan pp ON pp.id_pdb = p.id_pdb 
            WHERE pp.pilihan = 1 
            GROUP BY tanggal, kk, pilihan 
            ORDER BY tanggal';
            $insertQuery = array();
            $updateQuery = array();
            $deleteQuery = array();
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'lap.pendaftar');
            ...
            $this->dataset->AddLookupField('kk', '(SELECT * FROM kystudio_ref.kompetensi_keahlian)', new IntegerField('id_kk'), new StringField('nama_kk', false, false, false, false, 'kk_nama_kk', 'kk_nama_kk_ref_kompetensi_keahlian'), 'kk_nama_kk_ref_kompetensi_keahlian');
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_lap_pendaftar_kk_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('kk', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_lap_pendaftar_kk_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $selectQuery = 'SELECT * FROM kystudio_ref.kompetensi_keahlian';
            $insertQuery = array();
            $updateQuery = array();
            $deleteQuery = array();
            ...
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'edit_lap_pendaftar_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'multi_edit_lap_pendaftar_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'insert_lap_pendaftar_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_lap_pendaftar_kk_search', 'id_kk', 'nama_kk', null, 20);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_lap_pendaftar_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_lap_pendaftar_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_lap_pendaftar_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new lap_pendaftarPage("lap_pendaftar", "lap.pendaftar.php", GetCurrentUserPermissionsForPage("lap.pendaftar"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("lap.pendaftar"));
