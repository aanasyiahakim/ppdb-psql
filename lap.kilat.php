 ...
 */
    ...
    class lap_kilatPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Laporan Kilat');
            $this->SetMenuLabel('Laporan Kilat');
            ...
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'lap.kilat');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_lap_kilat_kk_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('kk', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_lap_kilat_kk_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'edit_lap_kilat_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'multi_edit_lap_kilat_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'insert_lap_kilat_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function CreateGrid()
        {
            ...
            $result->SetTotal('kk', PredefinedAggregate::$Count);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_lap_kilat_kk_search', 'id_kk', 'nama_kk', null, 20);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_lap_kilat_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_lap_kilat_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_lap_kilat_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new lap_kilatPage("lap_kilat", "lap.kilat.php", GetCurrentUserPermissionsForPage("lap.kilat"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("lap.kilat"));
