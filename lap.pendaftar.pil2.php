 ...
 */
    ...
    class lap_pendaftar_pil2Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Progres Pendaftar Pilihan 2');
            $this->SetMenuLabel('Progres Pendaftar Pilihan 2');
            ...
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'lap.pendaftar.pil2');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_lap_pendaftar_pil2_kk_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('kk', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_lap_pendaftar_pil2_kk_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'edit_lap_pendaftar_pil2_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'multi_edit_lap_pendaftar_pil2_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Kk', 'kk', 'kk_nama_kk', 'insert_lap_pendaftar_pil2_kk_search', $editor, $this->dataset, $lookupDataset, 'id_kk', 'nama_kk', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_lap_pendaftar_pil2_kk_search', 'id_kk', 'nama_kk', null, 20);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_lap_pendaftar_pil2_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_lap_pendaftar_pil2_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nama_kk', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_lap_pendaftar_pil2_kk_search', 'id_kk', 'nama_kk', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new lap_pendaftar_pil2Page("lap_pendaftar_pil2", "lap.pendaftar.pil2.php", GetCurrentUserPermissionsForPage("lap.pendaftar.pil2"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("lap.pendaftar.pil2"));
