 ...
 */
    ...
    class ref_kompetensi_keahlianPage extends Page
    {
    ...
    try
    {
        $Page = new ref_kompetensi_keahlianPage("ref_kompetensi_keahlian", "ref.kompetensi.keahlian.php", GetCurrentUserPermissionsForPage("ref.kompetensi.keahlian"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ref.kompetensi.keahlian"));
