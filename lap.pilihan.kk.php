 ...
 */
    ...
    class lap_pilihan_kkPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Laporan Pilihan Kompetensi Keahlian');
            $this->SetMenuLabel('Laporan Pilihan Kompetensi Keahlian');
    
            $selectQuery = 'SELECT 
                   `pp`.`status`, `pp`.`id_kk`, `pp`.`pilihan`, 
                   `kk`.`nama_kk`, `p`.`nopen`, 
                   `p`.`nama`, `p`.`nik`, `p`.`nisn`, `p`.`id_sp`, 
            ...
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'lap.pilihan.kk');
            $this->dataset->addFields(
                array(
                    new IntegerField('status', false, true),
                    new IntegerField('id_kk', false, true),
                    new IntegerField('pilihan', false, true),
                    new StringField('nama_kk', false, true),
                    new IntegerField('nopen', false, true),
                    new StringField('nama'),
                    new StringField('nik', false, true),
                    new StringField('nisn', false, true),
                    new StringField('id_sp'),
                    new StringField('nama_ayah'),
                    new StringField('nama_ibu'),
                    new StringField('kontak_pdb', false, true),
                    new StringField('kontak_ayah', false, true),
                    new StringField('kontak_ibu', false, true),
                    new StringField('kontak_lain', false, true)
                )
            );
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_lap_pilihan_kk_id_sp_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_sp', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_lap_pilihan_kk_id_sp_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Sekolah Asal', 'id_sp', 'id_sp_nama_sp', 'edit_lap_pilihan_kk_id_sp_search', $editor, $this->dataset, $lookupDataset, 'id_sp', 'nama_sp', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nama_sp', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sekolah Asal', 'id_sp', 'id_sp_nama_sp', 'multi_edit_lap_pilihan_kk_id_sp_search', $editor, $this->dataset, $lookupDataset, 'id_sp', 'nama_sp', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nama_sp', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sekolah Asal', 'id_sp', 'id_sp_nama_sp', 'insert_lap_pilihan_kk_id_sp_search', $editor, $this->dataset, $lookupDataset, 'id_sp', 'nama_sp', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nama_sp', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_lap_pilihan_kk_id_sp_search', 'id_sp', 'nama_sp', null, 20);
            ...
            $lookupDataset->setOrderByField('nama_sp', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_lap_pilihan_kk_id_sp_search', 'id_sp', 'nama_sp', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nama_sp', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_lap_pilihan_kk_id_sp_search', 'id_sp', 'nama_sp', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nama_sp', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_lap_pilihan_kk_id_sp_search', 'id_sp', 'nama_sp', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new lap_pilihan_kkPage("lap_pilihan_kk", "lap.pilihan.kk.php", GetCurrentUserPermissionsForPage("lap.pilihan.kk"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("lap.pilihan.kk"));
