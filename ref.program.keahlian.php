 ...
 */
    ...
    class ref_program_keahlianPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Program Studi Keahlian');
            $this->SetMenuLabel('Program Studi Keahlian');
    ...
    try
    {
        $Page = new ref_program_keahlianPage("ref_program_keahlian", "ref.program.keahlian.php", GetCurrentUserPermissionsForPage("ref.program.keahlian"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ref.program.keahlian"));
